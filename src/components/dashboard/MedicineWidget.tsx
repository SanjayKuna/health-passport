...
import { Pill, Clock, AlertCircle, Check, Loader2 } from "lucide-react";
    ...
    <Card variant="elevated">
      <CardContent className="p-6">
        ...
        {loading ? (
          ...
          <p className="text-sm text-muted-foreground text-center py-6">No medicines yet. Upload a prescription to get started.</p>
        ) : (
